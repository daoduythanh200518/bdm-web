          ...
          <div className="max-w-[520px] mx-auto lg:max-w-none w-full">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 text-white">
                <div className="text-xs md:text-sm font-semibold uppercase tracking-wider opacity-95">Hành trình</div>
                <div className="text-xl md:text-2xl font-extrabold drop-shadow-lg">15+ năm kinh nghiệm</div>
              </div>
            </div>
          </div>
          <div>
