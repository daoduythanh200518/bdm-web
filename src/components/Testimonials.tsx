      ...
      <div className="container-x">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-[26px] md:text-3xl lg:text-4xl font-extrabold mb-3">
            Khách Hàng Nói Gì Về Biển Đông Media?
          </h2>
          <p className="text-[var(--muted)] max-w-2xl mx-auto text-[14px] md:text-[15px] leading-relaxed">
            Mong muốn của chúng tôi đó là xây dựng mối quan hệ lâu dài với khách hàng, không chỉ là đối tác tin cậy trong công việc mà còn là người bạn thân thiết trong cuộc sống.
          </p>
        </div>
