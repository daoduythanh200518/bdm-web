...
import type { ServiceDetail as SD } from "@/lib/services";
      ...
      <section className="section-y bg-[var(--soft-bg)]">
        <div className="container-x">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-[24px] md:text-3xl font-extrabold mb-3">
      ...
      <section className="section-y bg-gradient-to-br from-[var(--primary)] to-[#c57100] text-white">
        <div className="container-x text-center">
          ...
          <p className="text-[14px] md:text-[15px] lg:text-lg opacity-95 mb-6 md:mb-7 max-w-2xl mx-auto leading-relaxed">
            Liên hệ ngay để được tư vấn gói dịch vụ phù hợp và nhận báo giá chi tiết.
          </p>
